	...
	var Game = new function(){
			...
			if (betplaced === true) {
				...
				if(whoiswin == "won"){
					...
					let newbetvalue = initalcoins + 100;
					 document.getElementById('player-coins').innerHTML = 'Your Coins :'+ newbetvalue ;
					...
					document.getElementById('player-coins').innerHTML = 'Your Coins :'+ lostcoins;
		...
		*/
		this.init = function(){
			...
			this.playercoins = document.getElementById('player-coins').getElementsByTagName("span")[0];
			...
			this.betcoinsButton.addEventListener('click',this.betcoinsHandler.bind(this));
